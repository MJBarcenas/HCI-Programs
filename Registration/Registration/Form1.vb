...
Public Class Form1
    ...
    Sub loadData()
        Try
            Dim query As String = "select studentnum, firstname, lastname, middlename, address, email, number, ispaid, year, section, accpass from students where ispaid=1 and section=''"
